    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/presencas/relatorio").hasRole("ADMINISTRADOR")
                        .requestMatchers(HttpMethod.GET, "/api/presencas/relatorio/atual").hasRole("ADMINISTRADOR")
                        .requestMatchers(HttpMethod.GET, "/api/presencas/dashboard").hasRole("ADMINISTRADOR")
                        .requestMatchers(HttpMethod.GET, "/api/presencas/dashboard/geral").hasRole("ADMINISTRADOR")
